...
/* package webhooktests-0.1.0.0 */
#ifndef VERSION_webhooktests
#define VERSION_webhooktests "0.1.0.0"
#endif /* VERSION_webhooktests */
#ifndef MIN_VERSION_webhooktests
#define MIN_VERSION_webhooktests(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_webhooktests */
...
#ifndef VERSION_http_listen
#define VERSION_http_listen "0.1.0.0"
#endif /* VERSION_http_listen */
#ifndef MIN_VERSION_http_listen
#define MIN_VERSION_http_listen(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_http_listen */
...
#define CURRENT_COMPONENT_ID "webhooktests-0.1.0.0-3C4DHWlXOVS2ZUknVH2SlA-webhooktests"
